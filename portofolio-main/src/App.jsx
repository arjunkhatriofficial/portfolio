        ...
        <div className="hero grid grid-cols-1 md:grid-cols-2 items-center pt-10 gap-6 md:gap-10">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
              <a 
  href="/portfolio/portofolio-main/public/assets/Arjun_Khatri_2026.pdf" 
  download="ArjunResume.pdf"
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10 px-2 sm:px-6" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I am a Certified AI Specialist and Full-Stack Developer passionate about building high-performance web applications powered by Machine Learning. I specialize in turning complex neural networks into functional, production-ready tools that are both powerful and easy to use. By blending advanced ML logic with scalable backend systems, I bridge the gap between sophisticated research and practical digital solutions.My focus is on architecting data-driven systems that are robust and efficient. I don't just plug in APIs—I leverage deep ML principles to optimize models, manage data pipelines, and ensure generative AI adds real value without slowing things down. Whether I’m engineering workflows, fine-tuning prompts, or building out responsive web structures, my goal is always the same: pushing the limits of technology through clean code and high-performance execution."
                  delay={150}
                  animateBy="words"
                  direction="top"
